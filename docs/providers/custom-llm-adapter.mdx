...
- [OpenAI Provider](/docs/providers/openai) -- reference implementation using the OpenAI SDK
- [Anthropic Provider](/docs/providers/anthropic) -- example of multi-provider adapter (Anthropic chat + OpenAI embeddings)
- [Custom Storage Guide](/docs/guides/custom-storage) -- building custom storage adapters
