...
| Model | Best For |
| --- | --- |
| `gpt-5.4-mini` | Default. Fast, cost-effective, good extraction quality. |
| `gpt-4o` | Higher accuracy on nuanced health conversations. |
| `gpt-4o-mini` | Balance of speed and capability. |
| `o3-mini` | Reasoning-focused tasks. |
