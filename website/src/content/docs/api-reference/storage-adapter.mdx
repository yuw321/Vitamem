...
1. A user reports: _"My A1C went from 7.4% to 6.8%."_
   - Profile is updated: `value: "6.8%"`, `previousValue: "7.4%"`
2. Later, the AI says: _"Great that your A1C is 6.8%!"_
...
:::note
This guard works in tandem with [role-aware extraction](/concepts/memory-extraction/#role-aware-extraction). The extraction pipeline avoids re-extracting echoed values in the first place, and the same-value guard acts as a second safety net at the storage layer.
:::
