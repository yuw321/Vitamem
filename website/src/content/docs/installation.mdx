...
You can also pass a custom `StorageAdapter` instance for other backends. See [Custom Storage](/guides/custom-storage/).

## Next Steps

  - [**Quickstart**](/quickstart/) -- Build your first health companion in 5 minutes
  - [**Tutorial**](/tutorial-first-project/) -- Step-by-step guide to building a health companion from scratch
